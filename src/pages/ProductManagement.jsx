...
function ProductManagement() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      >
        <h3 className="text-sm font-medium text-blue-900 mb-2">Available Categories</h3>
        ...
        <p className="text-xs text-blue-700 mt-2">
          ...
          <a href="#/admin/categories" className="underline ml-1">Manage Categories</a>
        </p>
      </motion.div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {['bronze', 'silver', 'gold', 'platinum'].map(tier => (
                  <div key={tier}>
                    ...
                    />
                    {errors[`${tier}Price`] && (
                      <p className="text-red-600 text-xs mt-1">{errors[`${tier}Price`].message}</p>
                    )}
                  </div>
                ))}
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                />
                {errors.minOrder && (
                  <p className="text-red-600 text-sm mt-1">{errors.minOrder.message}</p>
                )}
              </div>
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-4 mt-2">
                  ...
                  {Object.entries(product.pricing).map(([tier, price]) => (
                    <span key={tier} className="text-xs bg-gray-100 px-2 py-1 rounded">
